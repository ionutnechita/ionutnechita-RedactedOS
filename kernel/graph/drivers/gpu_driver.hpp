...
public:
    ...
    virtual void draw_single_pixel(uint32_t x, uint32_t y, color color) = 0;
    ...
    virtual void draw_single_char(uint32_t x, uint32_t y, char c, uint32_t scale, uint32_t color) = 0;
